<section class="different column" data-animation="showUp">
    <div class="column__content">
        ...
        <div class="cta_group">
            <a class="primary"
               href="<?= get_field('different-first-link-url'); ?>"><?= get_field('different-first-link-text'); ?></a>
            <a class="secondary"
               href="<?= get_field('different-second-link-url'); ?>"><?= get_field('different-second-link-text'); ?>
